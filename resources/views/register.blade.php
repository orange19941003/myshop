                ...
                <div class="col-lg-6 col-md-8 m-auto">
                    ...
                    <div class="register-wrapper">
                        ...
                        <form action="#" method="post">
                            ...
                            <div class="single-input-item mb-3">
                                <button type="button" class="btn btn btn-dark btn-hover-primary rounded-0" onclick="register();return false;">注册</button>
                            </div>
                            <!-- Register Button End -->
...
<script type="text/javascript">
    ...
    function register()
    {
        ...
        $.ajax({
            ...
            url:"",
            dataType:'json', 
            data: {email:email,_token:_token,name:name,pwd_one:pwd_one,pwd_two:pwd_two,code:code},
            success:function(res) {
                if (res.code != 2000)
                {
                    layer.msg(res.msg)
