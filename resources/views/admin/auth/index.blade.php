...
<div style="padding: 15px;">
    ...
    <div class="layui-input-inline" style="width: 300px;margin-left: 60%">
	...
	table.render({
	    ...
	    ,cols: [[ //表头
	    	{type: 'checkbox', fixed: 'left'}
	      	...
	      	,{field: 'pname', title: '父权限名', width:200}
	      	,{field: 'grade', title: '权限等级', width:100}
	      	,{field: 'url', title: 'URL', width:200}
	      	,{field: 'addtime', title: '创建时间', width:300}
	      	,{field: 'edittime', title: '修改时间', width:300}
